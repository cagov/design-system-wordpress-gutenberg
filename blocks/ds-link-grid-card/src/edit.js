 ...
 */
 import { Toolbar, ToggleControl, Button, TextControl, ToolbarGroup, ToolbarButton  } from '@wordpress/components';
...
export default function Edit(props) {
   ...
   const toggleVisible = () => {
	...
	//let linkAnchor = undefined !== linkInfo && undefined !== linkInfo.url ? linkInfo.url : '#';
